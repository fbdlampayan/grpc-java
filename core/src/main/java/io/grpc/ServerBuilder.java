...
public abstract class ServerBuilder<T extends ServerBuilder<T>> {
   ...
   * Makes the server use TLS.
   *
   * @param certChain stream containing the full certificate chain
   * @param privateKey stream containing the private key
   *
   * @return this
   * @throws UnsupportedOperationException if the server does not support TLS or using InputStream
   * @since 1.12.0
   */
