...
public class TransportBenchmark {
  ...
  private static final SimpleRequest BYTE_THROUGHPUT_REQUEST = SimpleRequest.newBuilder()
      .setResponseSize(1048576) // must match OperationsPerInvocation
      .build();

  @Benchmark
  @BenchmarkMode(Mode.Throughput)
  @OperationsPerInvocation(1048576) // must match BYTE_THROUGHPUT_REQUEST
  @Threads(10)
  public SimpleResponse unaryCallsByteThroughput() {
    return stub.unaryCall(BYTE_THROUGHPUT_REQUEST);
  }

  private static Throwable OK_THROWABLE = new RuntimeException("OK");
